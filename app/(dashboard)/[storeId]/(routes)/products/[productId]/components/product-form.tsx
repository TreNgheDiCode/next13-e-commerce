...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const title = initialData ? "Chỉnh sửa sản phẩm" : "Tạo mới sản phẩm";
  ...
  const onSubmit = async (data: ProductFormValues) => {
    try {
      ...
      toast.error("Lỗi xảy ra khi tương tác với sản phẩm")
    } finally {
      setLoading(false);
    }
  }
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Danh sách ảnh sản phẩm</FormLabel>
                <FormControl>
                  <ImageUpload 
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input disabled={loading} placeholder="Nhập tên sản phẩm" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue defaultValue={field.value} placeholder="Chọn một kích thước" />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
                      {sizes.map((size) => (
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue defaultValue={field.value} placeholder="Chọn một màu sắc" />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
                      {colors.map((color) => (
